...
from backend.core import (
    engine, run, rango, FAMILIA_SQL, SCHEMA,
...
# La sección de Chat conversacional (más abajo, todavía no movida a su propio
# router — ver tarea "Mover Chat conversacional") llama estas funciones como
# Python directo (tool-use, no HTTP) — se re-exportan aquí para que sigan
# resolviendo mientras chat.py no se extrae. Se elimina este bloque cuando se
# mueva el chat a backend/routers/chat.py.
from backend.routers.beta import beta_evaluar, beta_riesgo_alto
from backend.routers.alfa import alfa_evaluar, alfa_cuello_botella, alfa_clientes, alfa_partes_cliente, programa_mensual
